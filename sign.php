                ...
                <form class="col s12" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="input-field col s6">
                      <i class="material-icons prefix">email</i>
                      <input id="icon_prefix" placeholder="Email"  type="text" name="email" class="validate" required>
                    </div>
                    ...
                    <div class="input-field col s6">
                      ...
                      <input id="icon_prefix" placeholder="Frist Name" type="text" name="firstname" class="validate" required>
                    </div>

                    <div class="input-field col s6">
                      <i class="material-icons prefix">perm_identity</i>
                      <input id="icon_prefix" type="text" placeholder="Last Name"  name="lastname" class="validate" required>
                    </div>

                    <div class="input-field col s6">
                      <i class="material-icons prefix">lock</i>
                      <input id="icon_prefix" type="password" placeholder="Password" name="password" class="validate value1" required>
                    </div>

                    <div class="input-field col s6">
                      <i class="material-icons prefix">lock</i>
                      <input id="icon_prefix" type="password" name="confirmation" class="validate value2" placeholder="Confirm Password" required>
                    </div>
                    ...
                    <div class="input-field col s6 meh">
                      ...
                      <input id="icon_prefix" type="text" name="address" class="validate" placeholder="Address" required>
                    </div>
